...
//Define LCD Type,Only one
#define LCD160100
//#define LCD3310

//If no type define,error
#ifndef LCD160100
  #ifndef LCD3310
    #error"No LCD type define!"
  #endif
#endif

//Only define one type
#if defined(LCD160100)&&defined(LCD3310)
  #error"Too many LCD type define!"
#endif
